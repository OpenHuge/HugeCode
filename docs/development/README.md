...
Repo branch policy also accepts `codex/<slug>` so the default worktree branches generated by `apps/code`
stay compatible with doctor and collaboration scripts.
