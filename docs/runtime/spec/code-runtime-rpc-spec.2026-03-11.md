...
- Generated at: `2026-03-22T08:07:23.854Z`
- Contract version: `2026-03-11`
- Freeze effective at: `2026-03-11`
- Method-set hash: `b057c9aad3abd9a4`
...
- `app_server_protocol_v2_2026_03_11`
- `contract_frozen_2026_03_11`
...
- `code_runtime_tool_metrics_record`
- `code_runtime_tool_metrics_read`
- `code_runtime_tool_metrics_reset`
...
- `code_thread_snapshots_get_v1`
- `code_thread_snapshots_set_v1`
- `code_security_preflight_v1`
...
- `rpc`: `json-rpc-over-http-v1` on `/rpc` (rpc)
- `events`: `sse-v1` on `/events` (events)
- `ws`: `runtime-ws-v1` on `/ws` (duplex)
