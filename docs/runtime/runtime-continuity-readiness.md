...
| Review Pack surface composer             | `packages/code-application/src/runtime-control-plane/reviewPackSurfaceModel.ts`                                                                          | Review Pack detail model                                          | Yes                   | Retain as canonical shared composer                    | `code-application` owner. Apps and workspace shells consume this shared surface model directly.                                      |
| Mission Control operator-action composer | `packages/code-application/src/runtime-control-plane/missionControlSurfaceModel.ts`                                                                      | Mission Control rows and review-pack rows                         | Yes                   | Retain as canonical shared composer                    | `code-application` owner. Do not reintroduce app-local next-action precedence wrappers.                                              |
