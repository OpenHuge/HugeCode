...
| `code_kernel_job_callback_register_v3`, `code_kernel_job_callback_remove_v3`          | runtime contract, low-level client extensions, Rust dispatch                                                                                                                                                                                                                                                                                                  | Kernel-job callback compatibility residues        | Compat only      | Kept only because callback delivery does not yet have a v2-native replacement                                         | runtime contract + runtime client + runtime service   | Missing v2 callback replacement                |
