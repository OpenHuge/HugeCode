  ...
  it("registers all desktop host IPC handlers", () => {
    ...
    registerDesktopHostIpc({
      ...
      handlers: {
        ...
        ensureBrowserWorkspaceSession: vi.fn(),
        focusWindow: vi.fn(),
        getAppVersion: vi.fn(),
        getBrowserDebugSession: vi.fn(),
        getBrowserWorkspaceSession: vi.fn(),
        ...
        setBrowserWorkspaceAgentAttached: vi.fn(),
        setBrowserWorkspaceDevtoolsOpen: vi.fn(),
        navigateBrowserWorkspaceSession: vi.fn(),
        setBrowserWorkspacePaneState: vi.fn(),
        setBrowserWorkspaceHost: vi.fn(),
