...
async function installStageDependencies(processTempDir) {
  ...
  await new Promise((resolvePromise, rejectPromise) => {
    const child = spawn(
      npmCommand,
      [...argsPrefix, "install", "--include=dev", "--ignore-scripts", "--no-package-lock"],
      {
        cwd: forgePackageDir,
...
async function runForge() {
  ...
  try {
    ...
    await installStageDependencies(processTempDir);
