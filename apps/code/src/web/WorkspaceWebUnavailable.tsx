...
type WorkspaceWebUnavailableProps = {
  probeState?: "idle" | "probing" | "multiple" | "none";
  localRuntimeCandidates?: LocalRuntimeCandidate[];
  isConnectingCandidate?: boolean;
  onSelectLocalRuntimeCandidate?: (candidate: LocalRuntimeCandidate) => void;
};
      ...
      <div className={unavailablePanel}>
        <section className={unavailableHero}>
          ...
          <p className={unavailableBody}>
            ...
            runtime or a configured gateway endpoint. To enable browser access, set{" "}
          ...
          <p className={unavailableBody}>
            ...
            state still require a connected desktop runtime or gateway-backed runtime.
          </p>
          {probeState === "probing" ? (
            <div className={unavailableProbePanel}>
              <p className={unavailableProbeStatus}>
                Scanning common local runtime ports on this machine before falling back to manual
                setup.
              </p>
            </div>
          ) : null}
        ...
        <section className={unavailableDetails}>
          <article className={unavailableDetailCard}>
            ...
            <span className={unavailableDetailBody}>
              ...
              workflows inside the desktop host target. This is the path for writable execution and
              durable local state.
            </span>
          </article>
