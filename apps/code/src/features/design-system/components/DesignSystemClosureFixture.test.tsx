...
const DESIGN_SYSTEM_CLOSURE_TEST_TIMEOUT_MS = 15_000;
...
describe("DesignSystemClosureFixture", () => {
  it(
    "renders family-level closure evidence and opens overlay previews through explicit triggers",
    () => {
    ...
    DESIGN_SYSTEM_CLOSURE_TEST_TIMEOUT_MS
  );
});
