...
export function WorkspaceHomeAgentRuntimePluginControlPlane({
  workspaceId,
  pluginControlPlaneSurface,
  refreshRuntimeTasks,
  runtimeLoading,
    ...
    <MissionControlSectionCard
      ...
      meta={
        <>
          ...
          <ToolCallChip tone="neutral">Profiles {pluginControlPlane.counts.profiles}</ToolCallChip>
        </>
      }
    >
      ...
      {runtimePluginControlPlane.previewResolution ? (
        <div className="workspace-home-code-runtime-item">
          <div className="workspace-home-code-runtime-item-main">
            ...
            <span>
              Selected plugins: {runtimePluginControlPlane.previewResolution.selectedPlugins.length}
            </span>
            <span>
