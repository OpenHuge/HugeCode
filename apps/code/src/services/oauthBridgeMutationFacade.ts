...
import { createWebRuntimeOauthPersistenceUnavailableError } from "./oauthBridgeWebRuntime";
...
export type OAuthBridgeMutationFacadeDeps = {
...
export async function upsertOAuthAccount(
  deps: OAuthBridgeMutationFacadeDeps,
