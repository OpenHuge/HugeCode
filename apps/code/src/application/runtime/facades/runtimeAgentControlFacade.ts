...
export function createRuntimeAgentControlFacade(
  ...
  return {
    ...
    readRuntimeExecutableSkills: deps.readRuntimeExecutableSkills,
    resolveRuntimeExecutableSkill: deps.resolveRuntimeExecutableSkill,
    runRuntimeExecutableSkill: deps.runRuntimeExecutableSkill,
