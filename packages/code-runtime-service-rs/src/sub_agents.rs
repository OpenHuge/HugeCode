...
#[path = "sub_agents/presentation.rs"]
mod presentation;
...
use presentation::{
    build_sub_agent_item, build_sub_agent_projection_knowledge, build_sub_agent_result_summary,
    build_sub_agent_skill_candidates, derive_sub_agent_failure_class,
};
use profiles::{
