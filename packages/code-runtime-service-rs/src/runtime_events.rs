...
fn is_agent_job_scope_method(method: &str) -> bool {
    matches!(method,
        "code_runtime_run_start_v2" | "code_runtime_run_cancel_v2" | "code_runtime_run_resume_v2" | "code_runtime_run_intervene_v2"
...
fn is_extension_scope_method(method: &str) -> bool { matches!(method,
    ...
    | "code_extension_tools_list_v2" | "code_extension_tool_invoke_v2" | "code_extension_resource_read_v2") }
#[rustfmt::skip]
