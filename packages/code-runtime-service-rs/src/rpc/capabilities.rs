...
pub(super) const RPC_METHOD_REGISTRY: &[RpcMethodEntry] = &[
    ...
    RpcMethodEntry::new("code_runtime_composition_profile_list_v2"),
    ...
    RpcMethodEntry::new("code_extension_update_v2"),
    RpcMethodEntry::new("code_extension_set_state_v2"),
    RpcMethodEntry::new("code_extension_remove_v2"),
    RpcMethodEntry::new("code_extension_registry_search_v2"),
    RpcMethodEntry::new("code_extension_registry_sources_v2"),
